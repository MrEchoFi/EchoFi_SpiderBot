...
___________      .__          ___________.__       _________      .__    .___            __________        __   
\_   _____/ ____ |  |__   ____\_   _____/|__|     /   _____/_____ |__| __| _/___________ \______   \ _____/  |_ 
 |    __)__/ ___\|  |  \ /  _ \|    __)  |  |     \_____  \\____ \|  |/ __ |/ __ \_  __ \ |    |  _//  _ \   __\
 |        \  \___|   Y  (  <_> )     \   |  |     /        \  |_> >  / /_/ \  ___/|  | \/ |    |   (  <_> )  |  
/_______  /\___  >___|  /\____/\___  /   |__|____/_______  /   __/|__\____ |\___  >__|____|______  /\____/|__|  
        \/     \/     \/           \/      /_____/       \/|__|           \/    \/  /_____/      \/             BY MrEchoFi

Copyright 2025 @MrEchoFi_Md Abu Naser Nayeem_Tanjib Isham
  */

#define LONGDELAY 125
#define SHORTDELAY 47
#define SERVOMIN 0
#define SERVOMAX 180
...
front_left_hip.attach(13);   // Front Left Hip
front_left_knee.attach(12);  // Front Left Knee
front_right_hip.attach(14);  // Front Right Hip
front_right_knee.attach(27); // Front Right Knee
back_left_hip.attach(25);    // Back Left Hip
back_left_knee.attach(33);   // Back Left Knee
back_right_hip.attach(32);   // Back Right Hip
back_right_knee.attach(15);  // Back Right Knee

front_left_hip.attach(13, MIN_PULSE, MAX_PULSE);
front_left_knee.attach(12, MIN_PULSE, MAX_PULSE);
front_right_hip.attach(14, MIN_PULSE, MAX_PULSE);
front_right_knee.attach(27, MIN_PULSE, MAX_PULSE);
back_left_hip.attach(25, MIN_PULSE, MAX_PULSE);
back_left_knee.attach(33, MIN_PULSE, MAX_PULSE);
back_right_hip.attach(32, MIN_PULSE, MAX_PULSE);
back_right_knee.attach(15, MIN_PULSE, MAX_PULSE);
